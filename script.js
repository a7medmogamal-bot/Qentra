// ============ Configuration ============
// استخدم النموذج الجديد اللي مش decommissioned
const GROQ_API_KEY = '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';
// غير النموذج من القديم للجديد
const GROQ_MODEL = 'llama-3.2-11b-vision-preview'; // بدل 90b-vision-preview
...
async function generateQuestions() {
    ...
    try {
        ...
        const prompt = `You are QENTRA AI. Look at this image carefully and generate EXACTLY 10 questions based on it.

RULES:
1. Questions must be DEEP and MEANINGFUL - ask about concepts, relationships, cause-effect, analysis
2. DO NOT ask about superficial details like page numbers, formatting, colors, or layout
3. Questions should make the student THINK and understand the material deeply
4. Questions 1-3: Easy (basic understanding)
5. Questions 4-7: Medium (analysis and application)
6. Questions 8-10: Hard (critical thinking and synthesis)
