...
async function describeImage(imageBase64) {
    ...
    try {
        console.log('📸 وصف الصورة عبر Hugging Face...');
...
async function generateQuestionsFromText(text) {
    try {
        console.log('🤖 توليد الأسئلة من النص...');
...
async function generateQuestions() {
    ...
    showLoading('🔍 جاري التحليل مع Hugging Face...');
...
function init() {
    ...
    console.log('🔑 API Key:', HF_API_KEY.substring(0, 10) + '...');
}
